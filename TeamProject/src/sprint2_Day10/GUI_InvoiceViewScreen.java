 ...
 */
       // Create dummy Invoice variable to hold object attributes to populate text fields
        ...
        final JTable invoiceBasketTable = new JTable();  
        invoiceBasketTable.setModel(dtm);
        
		// double click to get more information
        invoiceBasketTable.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (e.getClickCount() == 2) {
					NewUI.selectedProductID = Integer.parseInt(invoiceBasketTable
							.getValueAt(invoiceBasketTable.getSelectedRow(), 0)
							.toString());
