 ...
 */
       // Create dummy Order variable to hold object attributes to populate text fields
        ...
        final JTable orderBasketTable = new JTable(); 
        orderBasketTable.setModel(dtm);
        
 		// double click to get more information
        orderBasketTable.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (e.getClickCount() == 2) {
					NewUI.selectedProductID = Integer.parseInt(orderBasketTable
							.getValueAt(orderBasketTable.getSelectedRow(), 0)
							.toString());
