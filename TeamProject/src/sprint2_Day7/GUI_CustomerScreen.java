...
// HEADER       
        ...
        customerTable.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (e.getClickCount() == 2) {
					NewUI.selectedCustomerID = Integer.parseInt( customerTable
							.getValueAt( customerTable.getSelectedRow(), 0 )
							.toString() );

					GUI_CustomerViewScreen gui_CustomerViewScreen = new GUI_CustomerViewScreen();
					gui_CustomerViewScreen.customerViewScreen();

					CardLayout cl = (CardLayout) (NewUI.gui.getLayout());
					cl.show(NewUI.gui, "customerView");
				}
			}
		});
        ...
        //Create Vdit button and set action listener
...
//      			  refresh(); 
        ...
        //If user is not admin, disable new customer
