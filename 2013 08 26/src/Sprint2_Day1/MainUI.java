...
public class MainUI extends JFrame {   
  //Otis made a change
    ...
    private final String homeScreenAccess = "home", productScreenAccess = "product", orderScreenAccess = "order", supplierScreenAccess = "supplierEdit", customerScreenAccess = "customer", invoiceScreenAccess = "invoice", 
            ...
            invoiceCreateScreenAccess = "invoiceCreate", invoiceEditScreenAccess = "invoiceEdit";             
    ...
    public void menuBar(){   
        ...
        productsmenu = new JMenu("Poducts");   
        ...
        productsView = new JMenuItem("View Products");  
        ...
        ordersView = new JMenuItem("View Orders");  
        ...
        customerView = new JMenuItem("View Cusomters");   
        ...
        supplierView = new JMenuItem("View Suppliers");   
        ...
        invoicesView = new JMenuItem("View Invoices");  
 ...
 **************************************************************************************/
 ...
 // Home Screen - Product, Order    
    public void homeScreen(){   
        ...
        JLabel titlelbl = new JLabel("Retail Solution Home Screen", JLabel.CENTER);    
        ...
        JButton reportsScreenButton = new JButton("Stock Contol");    
        //       reportsScreenButton.setActionCommand(actionCommand);    
        //       reportsScreenButton.addActionListener(new GUIListener());    
        reportsPanel.add(reportsScreenButton);    
...
// Product Screen - Create Product, Edit Product, Back    
    public void productScreen(){    
        ...
        JLabel titlelbl = new JLabel("Products Screen", JLabel.CENTER);    
        titlelbl.setFont(new Font("Arial",2 , 48));    
        topJP.add(titlelbl);    
...
// Create Product Screen - Cancel  
    ...
    //    row3.add(productCreateNameText);
       ...
       row5.add(productCreateRetailText);
        ...
        JLabel titlelbl = new JLabel("Create Product Screen", JLabel.CENTER);   
        titlelbl.setFont(new Font("Arial",2 , 48));   
        topJP.add(titlelbl);   
        botJP.setLayout(new BorderLayout());   
...
//      System.out.println(supplier.getName()); 
        ...
        JLabel titlelbl = new JLabel("Edit Product Screen", JLabel.CENTER); 
        titlelbl.setFont(new Font("Arial", 2, 48)); 
        topJP.add(titlelbl); 
        botJP.setLayout(new BorderLayout()); 
 ...
 // Order Screen - Create Order, Edit Order, Back   
     public void orderScreen(){   
         ...
         JLabel titlelbl = new JLabel("Orders Screen", JLabel.CENTER);   
         titlelbl.setFont(new Font("Arial",2 , 48));   
         topJP.add(titlelbl);   
 ...
 // Create Order Screen - Cancel  
    public void orderCreateScreen(){ 
        ...
        JButton orderCreateAddButton = new JButton("Add"); 
        ...
        orderCreateSubmitButton = new JButton("Submit"); 
        ...
        JLabel titlelbl = new JLabel("Create Order Screen", JLabel.CENTER);  
        titlelbl.setFont(new Font("Arial",2 , 48));  
        topJP.add(titlelbl);  
        botJP.setLayout(new BorderLayout());  
...
// Supplier Screen - Create Supplier, Back 
  public void supplierScreen(){ 
      ...
      JLabel titlelbl = new JLabel("Suppliers Screen", JLabel.CENTER);   
      titlelbl.setFont(new Font("Arial",2 , 48));   
...
// Create Supplier Screen - Cancel 
  public void supplierCreateScreen(){  
     ...
     //Create row1 Panel and add components
      ...
      JLabel titlelbl = new JLabel("Create Supplier Screen", JLabel.CENTER);   
      titlelbl.setFont(new Font("Arial",2 , 48));   
...
//	Customer screen - Create Customer, Back 
 public void customerScreen(){
     ...
     JLabel titlelbl = new JLabel("Customers Screen", JLabel.CENTER);  
     titlelbl.setFont(new Font("Arial",2 , 48));  
  ...
  public void customerCreateScreen(){ 
    ...
    //If the number is less than 10, convert to a double digit (necessary for date formatting) 
     days[i-1]=(i < 10 ? "0" : "")+ Integer.toString(i);  
      ...
      JLabel titlelbl = new JLabel("Create Customer Screen", JLabel.CENTER);   
      titlelbl.setFont(new Font("Arial",2 , 48));   
...
// 	Invoice Screen - Create Invoice, Edit Invoice, Back   
  public void invoiceScreen(){   
      ...
      JLabel titlelbl = new JLabel("Invoices Screen", JLabel.CENTER);   
      titlelbl.setFont(new Font("Arial",2 , 48));   
      topJP.add(titlelbl);   
...
//	Create Invoice Screen - Cancel  
  public void invoiceCreateScreen(){ 
      ...
      JButton invoiceCreateAddButton = new JButton("Add"); 
      ...
      invoiceCreateSubmitButton = new JButton("Submit"); 
      ...
      JLabel titlelbl = new JLabel("Create Invoice Screen", JLabel.CENTER);  
      titlelbl.setFont(new Font("Arial",2 , 48));  
      topJP.add(titlelbl);  
      botJP.setLayout(new BorderLayout());  
